                ...
                <div class="tab-content">
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                assets/ <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                    ...
                    <div class="tab-pane fade" id="notes">
                        <div class="card mb-sm-3 mb-md-0 note_card">
                            <div class="card-header chat-list-header text-center">
                                <a href="assets/javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewbox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect fill="#000000" x="4" y="11" width="16" height="2" rx="1"></rect>
                                            <rect fill="#000000" opacity="0.3" transform="translate(12.000000, 12.000000) rotate(-270.000000) translate(-12.000000, -12.000000) " x="4" y="11" width="16" height="2" rx="1"></rect>
                                        </g>
                                ...
                                <ul class="contacts">
                                    <li class="active">
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="ms-auto">
                                                <a href="assets/javascript:void(0);" class="btn btn-primary btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                <a href="assets/javascript:void(0);" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link " href="assets/javascript:void(0);">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link" href="assets/javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <svg width="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell-link " href="assets/javascript:void(0);">
                                    <svg width="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link " href="assets/javascript:void(0);" data-bs-toggle="dropdown">
                                    <svg width="28" height="28" viewbox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div id="DZ_W_TimeLine02" class="widget-timeline dlab-scroll style-1 ps ps--active-y p-3 height370">
                                        <ul class="timeline">
                                            <li>
                                                ...
                                                <a class="timeline-panel text-muted" href="assets/javascript:void(0);">
                            ...
                            <li class="nav-item dropdown  header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="assets/page-error-404.html" class="dropdown-item ai-icon">
                ...
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="assets/project-page.html">Project</a></li>
                            <li><a href="assets/contacts.html">Contacts</a></li>
                            <li><a href="assets/kanban.html">Kanban</a></li>
                            <li><a href="assets/calendar-page.html">Calendar</a></li>
                            <li><a href="assets/message.html">Messages</a></li>
                        </ul>

                    </li>

                    <li><a class="has-arrow " href="assets/javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="assets/javascript:void()" aria-expanded="false">Email</a>
                                <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="assets/javascript:void()" aria-expanded="false">Shop</a>
                                <ul aria-expanded="false">
