...
<body>
    ...
    <div class="container-fluid">
        <div class="row nav">
            ...
            <div class="col-md-6">
                <div class="btn-s">
                    <button class="btn-i">Sign In</button>
                    <button class="btn-u">Sign Up</button>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid pad">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="slider">
                    <img src="assets/kelly-sikkema-9OGNpJPVMZ8-unsplash.jpg" alt="">
                    <img src="assets/bookblock-JPHPdqZrB3I-unsplash.jpg" alt="">
                    <img src="assets/glenn-carstens-peters-npxXWgQ33ZQ-unsplash.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top: 50px;">
                <div class="about-img">
                    <img src="assets/glenn-carstens-peters-RLw-UC03Gwc-unsplash.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
